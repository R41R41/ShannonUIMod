...
public class TaskPrioritizeEndpoint implements HttpHandler {
    ...
    private void handlePost(HttpExchange exchange) throws IOException {
        try {
            ...
            LOGGER.info("📤 Task prioritize request: {}", requestBody);

            // バックエンドに転送
            String backendUrl = ModConfig.BACKEND_BASE_URL + ModConfig.ENDPOINT_TASK_PRIORITIZE;
            ...
            LOGGER.error("Task prioritize error: {}", e.getMessage());
